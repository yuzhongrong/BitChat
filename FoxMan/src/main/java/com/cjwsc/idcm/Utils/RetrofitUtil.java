...
/**
 * Created by licnese on 2017/9/24.
 */
...
public class RetrofitUtil {
    ...
    public static MultipartBody onefilesToMultipartBody(File file, String key) {
        MultipartBody.Builder builder = new MultipartBody.Builder();
        // TODO: 16-4-2  这里为了简单起见，没有判断file的类型
        String mediatype;
        if (file.getName().endsWith(".jpeg") || file.getName().endsWith(".jpg")) {
    ...
    public static MultipartBody onefilesToMultipartBody(String path, String key) {
        MultipartBody.Builder builder = new MultipartBody.Builder();
        // TODO: 16-4-2  这里为了简单起见，没有判断file的类型
        String mediatype = "";
