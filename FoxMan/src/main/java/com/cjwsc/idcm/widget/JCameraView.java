...
import com.cjt2325.cameralibrary.CameraParamUtil;
...
public class JCameraView extends RelativeLayout implements SurfaceHolder.Callback, Camera.AutoFocusCallback, CameraFocusListener {
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconWidth = a.getDimensionPixelSize(com.cjt2325.cameralibrary.R.styleable.JCameraView_iconWidth, (int) TypedValue.applyDimension(
        ...
        iconSrc = a.getResourceId(com.cjt2325.cameralibrary.R.styleable.JCameraView_iconSrc, com.cjt2325.cameralibrary.R.drawable.ic_repeat_black_24dp);
